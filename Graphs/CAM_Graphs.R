...
#rename 
#colnames(TE_Data)[colnames(TE_Data)=="oldname"] <- "newname"

#colnames(TE_Data)[colnames(TE_Data)=="CMC_EnSpm_left"] <- "CMC_EnSpm_left"
#colnames(TE_Data)[colnames(TE_Data)=="CMC_EnSpm_intra"] <- "CMC_EnSpm_intra"
#colnames(TE_Data)[colnames(TE_Data)=="CMC_EnSpm_right"] <- "CMC_EnSpm_right"
...
#colnames(TE_Data)[colnames(TE_Data)=="LINE_fam_left"] <- "LINEFam_left"
#colnames(TE_Data)[colnames(TE_Data)=="LINE_fam_intra"] <- "LINEFam_intra"
#colnames(TE_Data)[colnames(TE_Data)=="LINE_fam_right"] <- "LINEFam_right"
...
#Subset to look only at TE families and rename column to TE_family
# Will need to be renamed in a spot once the LINE fam is added
#TE.Family.Density.Means<-TE.Density.Means[TE.Density.Means$TE_type=="Unknown_fam"|TE.Density.Means$TE_type=="PIF_Harbinger"|TE.Density.Means$TE_type=="LINE"|TE.Density.Means$TE_type=="MULE"|TE.Density.Means$TE_type=="Copia"|TE.Density.Means$TE_type=="Gypsy"|TE.Density.Means$TE_type=="LTRUnknown"|TE.Density.Means$TE_type=="hAT"|TE.Density.Means$TE_type=="CMC_EnSpm",]
#colnames(TE.Family.Density.Means)[2]<-"TE_Family" # LINE fam not none
